...
-- AddForeignKey
ALTER TABLE "team_member" ADD CONSTRAINT "team_member_dealership_id_fkey" FOREIGN KEY ("dealership_id") REFERENCES "dealership"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
